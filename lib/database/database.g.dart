...
class $UsersConsumedMealsTable extends UsersConsumedMeals
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, userId, foodId, usersMealId, date, typeOfMeal, amount];
  @override
...
class UsersConsumedMeal extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, userId, foodId, usersMealId, date, typeOfMeal, amount);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
